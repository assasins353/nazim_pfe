...
class BlogController extends Controller
{
    ...
    public function store(Requests\StorePostRequest $request)
    {
        ...
        return redirect(route('backend.blog.index'))->with('status', 'L\'article a été crée.');
    }
    ...
    public function update(Requests\UpdatePostRequest $request, $id)
    {
        ...
        return redirect(route('backend.blog.edit', $post->id))->with('status', 'L\'article a été modifié.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('backend.blog.index'))->with('status', 'L\'article a été supprimé.');
    }
}
